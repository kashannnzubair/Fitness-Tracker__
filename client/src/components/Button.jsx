...
const StyledButton = styled.div`
  ...
  ${({ type, theme }) =>
    type === "secondary"
      ? `background: ${theme.secondary}; border: 1px solid ${theme.secondary};`
      : `background: ${theme.primary};`}

  ${({ $isDisabled }) => $isDisabled && `opacity: 0.8; cursor: not-allowed;`}
...
const Button = ({
  text, isLoading, isDisabled, rightIcon, leftIcon,
  type, onClick, flex, small, outlined, full,
}) => {
  return (
    <StyledButton
